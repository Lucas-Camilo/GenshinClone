...
namespace GenshinImpactMovementSystem
{
    public class PlayerGroundedState : PlayerMovementState
    {
        ...
        protected override void AddInputActionsCallbacks()
        {
            ...
            stateMachine.Player.Input.PlayerActions.Atack.started += OnAtackStarted;
        }
        ...
        protected virtual void OnAtackStarted(InputAction.CallbackContext context)
        {
            stateMachine.ChangeState(stateMachine.AtackingState);
        }
